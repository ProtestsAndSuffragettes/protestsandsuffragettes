...
function pns_pattern_audit_classify_block( $block, $page ) {
	...
	$class_mappings = array(
		...
		'pns-split-section'            => 'pns/split-section block via its Image, Slideshow, or YouTube variation',
		...
		'pns-suffragette-image-strip'  => 'patterns/image-strip.php (legacy compatibility class)',
