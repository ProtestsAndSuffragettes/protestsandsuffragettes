...
| PNS/RAN plugins     | Custom block registration and feature behaviour, including PNS layouts, Herstories content, canonical search routing, enhanced covers, shop teasers, and form integrations. | The site-wide PNS visual composition supplied by the theme.                                           |
...
| PNS Search Routing (`pns-search-routing/pns-search-routing.php`)                                         | Yes      | Canonical public search routes and the editorial post/page search scope; the theme owns the landing-page and result presentation.     |
